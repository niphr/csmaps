...
Every csmaps dataset name follows one consistent pattern, and each Norway map
comes in a few layouts. This vignette explains the naming scheme and then shows
